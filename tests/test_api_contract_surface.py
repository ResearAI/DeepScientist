...
def test_backend_routes_cover_shared_web_and_tui_surface() -> None:
    expected_routes = [
        ...
        ("POST", "/api/v1/projects/q-001/latex/quest-dir::q-001::paper%2Flatex/versions/auto", "latex_version_auto"),
...
def test_local_workspace_does_not_route_markdown_or_commands_through_dead_notebook_and_auth_paths() -> None:
    ...
    assert "version_show_build_snapshots" in latex_plugin_source
