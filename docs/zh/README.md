...
- [34 Experience Distillation Guide](../en/34_EXPERIENCE_DISTILL_GUIDE.md)
  让一个 quest 进入跨 quest 经验蒸馏管线时阅读：finalize 终结门、`decision(action='distill_review')` 制品、以及 `recall_priors` 跨 quest 检索。（中文版已移除，请阅读英文文档。）
